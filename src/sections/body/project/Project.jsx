...
const Project = () => {
    return (
        <SectionWrapper id="projets" className="pt-18 xl:pt-20  mb-[50vh] bg-[#dfdff0]">
            <h2 className="text-2xl md:text-3xl xl:text-4xl font-medium text-center mb-10">Projets Sélectionnés</h2>
            <div className="mt-12 h-[2px] w-3/4 md:w-2/3 xl:w-1/2 mx-auto"/>
            <div className="w-3/4 md:w-2/3 xl:w-1/2 mx-auto">
                {myProject.map((project) => (
                    <ProjectList key={project.id} {...project} />
                ))}
            </div>
            <div className=" mt-12 h-[2px] w-3/4 md:w-2/3 xl:w-1/2 mx-auto pb-[50vh]"/>
            <img
                src="/assets/project/project.webp"
                alt=""
