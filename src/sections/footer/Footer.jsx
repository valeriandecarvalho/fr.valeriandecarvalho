...
const Footer = () => {
    ...
    return (
        <>
            <div className="bottom-0 left-0 right-0 bg-primary/90 backdrop-blur-sm text-hover text-xs text-center py-1 xl:py-2 font-sans">
                <div className="bg-gradient-to-r from-transparent via-secondary to-transparent mb-12 h-[1px] w-2/3 mx-auto"></div>
                ...
                <div className="grid grid-cols-1 xl:grid-cols-3 w-2/3 mx-auto mb-2">
                    ...
                    <div className="text-center xl:col-start-3 xl:row-start-1 mb-10 xl:mb-0">
                        <button
                            onClick={() => setShowCGU(true)}
                            className="hover:underline cursor-pointer text-hover transition-colors duration-200"
                        >
                    ...
                    {/* Colonne 3 - Copyright */}
                    <div className="text-center xl:col-start-1 xl:row-start-1">
                        © 2025 Valérian. Tous droits réservés.
                    </div>
                </div>

                <div className="bg-gradient-to-r from-transparent via-text/50 to-transparent mt-12 mb-8 h-[1px] w-1/4 mx-auto"></div>
                <div className="italic text-text/50 mb-8">"La technologie au service de l'innovation"</div>
            </div>
